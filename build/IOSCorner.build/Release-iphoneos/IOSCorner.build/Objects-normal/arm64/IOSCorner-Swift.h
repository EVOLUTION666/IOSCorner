...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IOSCorner",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9IOSCorner11AppDelegate")
...
@interface MapViewController (SWIFT_EXTENSION(IOSCorner)) <CLLocationManagerDelegate>
...
@interface MapViewController (SWIFT_EXTENSION(IOSCorner)) <MKMapViewDelegate>
...
@interface Order (SWIFT_EXTENSION(IOSCorner))
@property (nonatomic, copy) NSString * _Nullable bayerName;
@property (nonatomic) int16_t count;
@property (nonatomic, copy) NSString * _Nullable descriptionOrder;
@property (nonatomic, copy) NSUUID * _Nullable id;
@property (nonatomic, copy) NSData * _Nullable imageOrder;
@property (nonatomic, copy) NSString * _Nullable namePosition;
...
SWIFT_CLASS("_TtC9IOSCorner13SceneDelegate")
...
SWIFT_CLASS("_TtC9IOSCorner14ViewController")
@interface ViewController : UITableViewController
@property (nonatomic, strong) IBOutlet UIBarButtonItem * _Null_unspecified busketBarButton;
- (void)viewDidLoad;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)tableView:(UITableView * _Nonnull)tableView heightForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (IBAction)busketAction:(id _Nonnull)sender;
